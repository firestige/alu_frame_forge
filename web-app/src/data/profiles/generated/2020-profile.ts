...
export const profile2020Normalized: NormalizedCrossSection = {
  ...
  holes: [
    'M 133.95,178.44 A 44.49,44.49 0 1,1 222.93,178.44 A 44.49,44.49 0 1,1 133.95,178.44 Z',
  ],
  dimensions: {
    width: 20,
    height: 20,
  ...
  annotation: {
    ...
    annotatedAt: '2025-12-14T16:57:25.104Z',
    autoDetected: true,
    confidence: 0.5,
    schemaVersion: '2.0.0',
    notes:
...
export const profile2020Asset: ProfileAsset = {
  ...
  metadata: {
    createdAt: '2025-12-14T16:57:25.106Z',
    updatedAt: '2025-12-14T16:57:25.106Z',
